...
### 깨우기 모드 (PIN 불필요)
1. 앱의 커피잔 버튼을 토글하거나 메뉴바에서 선택합니다.
2. Mac을 정상적으로 사용하면서 시스템 수면이 방지됩니다.
3. 완료되면 다시 토글하여 해제합니다.
